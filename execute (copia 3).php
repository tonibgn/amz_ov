...
$newurl = $emo.json_decode(file_get_contents("http://api.bit.ly/v3/shorten?login=".$loginBitly."&apiKey=".$ApiBitly."&longUrl=".urlencode("".$newurl."")."&format=json"))->data->url.PHP_EOL.PHP_EOL;
