...
//$short_url = json_decode(file_get_contents("http://api.bit.ly/v3/shorten?login=o_20dp36acoe&apiKey=R_ba00045734e84121a68e1f1194198f2f&longUrl=".urlencode("http://www.amazon.it/dp/B01J0RYDPG/?tag=tebl0f-21")."&format=json"))->data->url;
...
/*$amz="http://amzn.to/2fUY77s";
$amz=ger_origenal_url($amz);
$parametersc = array('chat_id' => $chatId, "text" => $amz);
$parametersc["method"] = "sendMessage";
echo json_encode($parametersc);*/
